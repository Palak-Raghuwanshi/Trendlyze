      ...
      <div className="glass-panel px-3 sm:px-6 py-2 sm:py-3 rounded-xl sm:rounded-full">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-white font-semibold text-sm sm:text-lg">Trendlyze</span>
          </div>
      ...
      <Router>
        <div className="App">
          <Routes>
            ...
            <Route path="/" element={
              <PublicLayout 
                title="Trendlyze - Social Media Management Made Simple"
