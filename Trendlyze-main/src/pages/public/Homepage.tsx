  ...
  const testimonials = [
    {
      ...
      content: 'Trendlyze has transformed our social media strategy. We\'ve seen a 300% increase in engagement since switching.',
      rating: 5,
    ...
    },
    {
      ...
      content: 'As a solo creator, Trendlyze helps me maintain consistent posting across all platforms. It\'s a game-changer!',
      rating: 5,
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="responsive-text-lg sm:text-xl text-white/70">
              See what our customers have to say about Trendlyze
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="glass-card p-6 sm:p-8 lg:p-12 rounded-xl sm:rounded-2xl">
            ...
            <p className="responsive-text-lg sm:text-xl text-white/80 mb-6 sm:mb-8 px-4">
              Join thousands of businesses already using Trendlyze to grow their online presence.
            </p>
