...
const AboutUs: React.FC = () => {
  ...
  const milestones = [
    { year: '2020', event: 'Trendlyze founded with a vision to simplify social media management' },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-white/80 leading-relaxed">
                <p>
                  Trendlyze was born out of frustration with existing social media management tools 
                ...
                <p>
                  Today, Trendlyze serves over 50,000 users worldwide, from solo entrepreneurs to 
      ...
      <section className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-white/70">
            The passionate people behind Trendlyze
          </p>
        </div>
      ...
      <section className="max-w-4xl mx-auto text-center">
        <div className="glass-card p-12 rounded-2xl">
          ...
          <p className="text-xl text-white/80 mb-8">
            ...
            already using Trendlyze to grow their online communities.
          </p>
