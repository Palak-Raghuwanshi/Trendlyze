  ...
  const faqs = [
    {
      ...
      question: 'How do I get started with Trendlyze?',
    ...
    },
    {
      id: 2,
      category: 'getting-started',
      question: 'Which social media platforms does Trendlyze support?',
    ...
    },
    {
      id: 8,
      category: 'features',
      question: 'Does Trendlyze provide analytics?',
    ...
    },
    {
      id: 9,
      category: 'technical',
      question: 'Is my data secure with Trendlyze?',
    ...
    },
    {
      id: 10,
      category: 'technical',
      question: 'What happens if Trendlyze is down?',
    ...
    },
    {
      ...
      question: 'Does Trendlyze have an API?',
    ...
    },
    {
      ...
      answer: 'Yes! Our Zapier integration allows you to connect Trendlyze with over 3,000 apps to automate your workflows.'
    }
  ];
    ...
    <div className="space-y-20 px-6 py-12">
      ...
      <section className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-xl text-white/80 leading-relaxed mb-8">
          Find answers to common questions about Trendlyze, or get in touch with our support team.
        </p>
      ...
      <section className="max-w-4xl mx-auto text-center">
        <div className="glass-card p-12 rounded-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="mailto:support@trendlyze.com"
